            ...
            <div id="toolbarContainer">
                ...
                <div className="dropdownContainer" style={{display: this.state.display}}>
                    <div className="dropdownItem" value="Newest" onClick={(e) => {this.props.sortReviews(e.target.textContent.split(' ')[0]); this.handleSelection(e)}} >
                        ...
                        </svg><span className="dropdownText">Newest</span>        
                    </div>
                    <div className="dropdownItem" value="Highest"onClick={(e) => {this.props.sortReviews(e.target.textContent.split(' ')[0]); this.handleSelection(e)}} ><svg id="Capa_1" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 430.602 430.602" >
                            <g>
                                <path d="M215.301,60c41.482,0,80.481,16.154,109.814,45.486c29.332,29.332,45.485,68.332,45.485,109.814
                                c0,41.481-16.153,80.481-45.485,109.813c-29.333,29.332-68.332,45.486-109.814,45.486c-41.482,0-80.481-16.154-109.814-45.486
                                C76.155,295.781,60.001,256.781,60.001,215.3c0-41.482,16.154-80.482,45.486-109.814C134.82,76.155,173.819,60,215.301,60
                        ...
                        </svg><span className="dropdownText">Highest Rating</span></div>
                    <div className="dropdownItem" value="Lowest" onClick={(e) => {this.props.sortReviews(e.target.textContent.split(' ')[0]); this.handleSelection(e)}} ><svg id="Capa_1" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 430.602 430.602" >
                            <g>
                                <path d="M215.301,60c41.482,0,80.481,16.154,109.814,45.486c29.332,29.332,45.485,68.332,45.485,109.814
                                c0,41.481-16.153,80.481-45.485,109.813c-29.333,29.332-68.332,45.486-109.814,45.486c-41.482,0-80.481-16.154-109.814-45.486
                                C76.155,295.781,60.001,256.781,60.001,215.3c0-41.482,16.154-80.482,45.486-109.814C134.82,76.155,173.819,60,215.301,60
                        ...
                        </svg><span className="dropdownText">Lowest Rating</span></div>
                </div>
